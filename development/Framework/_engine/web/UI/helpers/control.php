...
abstract class Control implements IControl
{
   ...
   public function __set($param, $value)
   {
      ...
      elseif (array_key_exists($param, $this->properties)) $this->properties[$param] = $value;
   ...
   public function boolClass($bool, $class)
   {
      return ($bool ? $this->addClass($class) : $this->removeClass($class));
   }


   public function error($bool=true, $def = "error")
   {
      return $this->boolClass($bool, $def);
   }
   ...
   public function show()//($def = 'block')
   {
      $def = func_num_args() ? func_get_arg(0) : 'block';
      $this->addStyle('display',$def);
      return $this;
   }

   public function display($bool,$def='block')
   {
     return ($bool ? $this->show($def) : $this->hide());
   }
