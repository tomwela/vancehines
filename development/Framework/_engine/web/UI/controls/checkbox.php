...
class CheckBox extends WebControl
{
   public function __construct($id, $value = null, $caption = null)
   {
      ...
      $this->attributes['captionStyle'] = null;
   ...
   public function render()
   {
      ...
      if ($this->properties['caption'] != '') $label = '<span style="'.$this->attributes['captionStyle'].'">' . $this->properties['caption'] . '</span>';
