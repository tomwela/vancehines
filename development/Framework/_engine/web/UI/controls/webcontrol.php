...
abstract class WebControl extends Helpers\Control implements IWebControl
{
   ...
   {
      return '<' . $this->reg->config['templateControlPrefix'] . strtolower(Utils\PHPParser::getClassName(get_class($this)))  . $this->getXHTMLParams() . ' />';
   }
   ...
   {
      $this->ajax->script("controls.focus('{$this->attributes['uniqueID']}')");
   }   
}
