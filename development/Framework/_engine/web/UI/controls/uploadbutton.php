...
class UploadButton extends Upload
{
   ...
   public function JS()
   {
      ...
      $this->ajax->runScript('uploadbutton.initialize(\'' . $this->attributes['uniqueID'] . '\', ' . (int)$this->properties['x'] . ', ' . (int)$this->properties['y'] . ');');
   }
   ...
   public function render()
   {
      ...
      $this->attributes['style'] = 'position:absolute;width:155px;cursor:pointer;top:-5000px;z-index:1;filter:alpha(opacity:0);opacity:0;';
