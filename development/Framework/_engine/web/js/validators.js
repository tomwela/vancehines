var Validators = function()
{
   ...
   this._showResult = function(flag, class1, class2)
   {
      ...
      for (var cid in this.results)
      {
         ...
         if (this.results[cid])
         {
            ...
            {
               if (typeof class1 === 'function') class1(el, true);
               else
               {
         ...
         else
         {
            ...
            if (typeof class1 === 'function') class1(el, false);
            else if (class1 != undefined && class2 != undefined && (' ' + el.className + ' ').indexOf(' ' + class1 + ' ') == -1)
            {
   ...
   {
      var keys = new Array(), vals = {}, bind = this;
...
if( undefined == window.validators )
