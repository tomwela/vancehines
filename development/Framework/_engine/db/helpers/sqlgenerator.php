...
class SQLGenerator
{
   ...
   public function getByQuery($class, $where = null, $start = null, $limit = null, $fields = array(), $group = null)
   {
      $class = Utils\PHPParser::getClassName($class);
      $tb = $this->objInfo->getTableAliasByClassName($class);
      $db = $this->orm->getDB($tb[0]);
      ...
      return 'SELECT ' . $fields . ' FROM ' . implode(', ', array_reverse($t)) . " $where $group $l ";
   }
}
