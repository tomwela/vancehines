...
<!--             <td width="100%" height="30"><P align="center"><input type="duplicate" name="duplicate" value="Duplicate"></P></td> -->
            <td width="100%" height="30"><P align="center"><input type="submit" name="submit" value="Submit"></P></td> 
        </tr>
		...
		//-----check if the form has been submitted.-------
 		...
 		{ 
 			...
 			if (is_numeric($_POST['id']))
 			{
                ...
                $newstate = "False";
                $q = "UPDATE ota SET id='$id',min_firmware='$min_firmware',firmware='$firmware',hardware='$hardware',app='$app',os='$os',filename='$filename',vin='$vin',wb_min_firmware='$wb_min_firmware',wb_max_firmware='$wb_max_firmware',wb_hardware='$wb_hardware',wb_filename='$wb_filename',wb_vin='$wb_vin'WHERE id='$id'";
